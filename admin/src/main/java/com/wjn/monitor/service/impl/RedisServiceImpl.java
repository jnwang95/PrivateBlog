package com.wjn.monitor.service.impl;

import cn.hutool.core.convert.Convert;
import com.wjn.monitor.domain.RedisInfo;
import com.wjn.monitor.exception.RedisConnectException;
...
public class RedisServiceImpl implements RedisService {
	...
	public List<RedisInfo> getRedisInfo() throws RedisConnectException {
		...
		for (Map.Entry<Object, Object> entry : info.entrySet()) {
			...
			redisInfo.setKey(Convert.toStr(entry.getKey()));
			redisInfo.setValue(Convert.toStr(entry.getValue()));
